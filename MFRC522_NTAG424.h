#ifndef MFRC522_NTAG424_H
#define MFRC522_NTAG424_H
...
class MFRC522_NTAG424 : public MFRC522_I2C_Extended, public NTAG424_Handler {
public:
  explicit MFRC522_NTAG424(uint8_t i2cAddress = kDefaultAddress,
                           TwoWire *wire = &Wire);

  bool begin(bool initWire = true);
  bool begin(int sda, int scl, uint32_t frequency = 400000);
...
private:
  MFRC522_NTAG424_Adapter _ntag424_adapter;
};
